...
if internet_gateways:
    ...
    print(f"Internet Gateway {vpc_name} with ID '{ig_id}' already exists.")
else:
    ...
    print(f"VPC {vpc_name} with ID '{vpc_id}' has been created.")
    print(f"Internet Gateway {vpc_name} with ID '{ig_id}' has been created.")
time.sleep(5)
#  Create a rouble table and a public route
...
print(f"subnet_1 ID = '{subnet_1['Subnet']['SubnetId']}', subnet_2 ID = '{subnet_2['Subnet']['SubnetId']}', subnet_3 "
      f"ID = '{subnet_3['Subnet']['SubnetId']}'")